...
declare module 'avenger/lib/graph' {
  ...
  export type QueryArgs<
    ...
    > = {
      ...
      params: {[k in keyof A]: t.Type<any> },
  ...
  export function Query<A extends {}, P,
    D1 extends Dependencies
    >(args: QueryArgs<A, P, D1>): QueryReturn<A & DepA<D1>, P>
  export function Query<A extends {}, P,
    D1 extends Dependencies, D2 extends Dependencies
    >(args: QueryArgs<A, P, D1 & D2>): QueryReturn<A & DepA<D1> & DepA<D2>, P>
  export function Query<A extends {}, P,
    D1 extends Dependencies, D2 extends Dependencies, D3 extends Dependencies
    >(args: QueryArgs<A, P, D1 & D2 & D3>): QueryReturn<A & DepA<D1> & DepA<D2> & DepA<D3>, P>
  ...
  export type QueryGraph = { [k: string]: QueryReturn<any, any> }
  export function make(graph: QueryGraph): QueryGraph
}
